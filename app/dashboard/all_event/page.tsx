          ...
          {currentEvents.map((event) => (
            ...
            >
              {/* Zone 1: Image/Visualisation de l'événement */}
                ...
                <div className="p-5 flex flex-col gap-2 bg-neutral-900">
                  <div className="absolute left-3 bottom-3 z-10">
                    <h2 className="text-xl font-bold text-white mb-0 truncate drop-shadow-lg" style={{maxWidth:'60vw'}}>{event.name}</h2>
                  </div>
                  <p className="text-gray-300 text-sm mb-2">{event.date ? new Date(event.date).toLocaleDateString("fr-FR", { day: "numeric", month: "long", year: "numeric" }) : ''}</p>
